...
if 'minimum_value_input_CO_nonaq' not in st.session_state:
    st.session_state.minimum_value_input_CO_nonaq = str(0.001)
...
PFD_svg = open("figures/2b 20250317 Non-aq CO flow diagram.svg", 
               'r', 
               encoding='utf-8')
